...
public final class XsdGen {
    ...
    private Document getDocument(InputStream is) throws ParsingException, IOException {
        return getDocument(new InputStreamReader(is));
    }
    
    private Document getDocument(Reader reader) throws ParsingException, IOException {
        try {
            Builder parser = new Builder();
            Document d = parser.build(reader);
    ...
    public XsdGen parse(File file) throws IOException, ParsingException {
        return parse(new FileInputStream(file));
    }
    
    public XsdGen parse(Reader is) throws IOException, ParsingException {
    ...
    public XsdGen parse(InputStream is) throws IOException, ParsingException {
